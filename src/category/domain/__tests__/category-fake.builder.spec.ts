...
describe('CategoryFakerBuilder Unit Tests', () => {
    describe('category_id prop', () => {
        ...
        test('should pass index to category_id factory', () => {
            ...
            expect(fakerMany.build()[0].id.toString()).toBe(categoryId.toString());
            expect(fakerMany.build()[1].id.toString()).toBe(categoryId.toString());
        });
    });
    ...
    test('should create a category', () => {
        ...
        expect(category.id.toString()).toBe(category_id.toString());
