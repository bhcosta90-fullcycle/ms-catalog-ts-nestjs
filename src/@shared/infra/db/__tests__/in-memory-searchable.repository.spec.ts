...
import {SearchParams} from "../../../domains/repositories/search-params";
...
class StubEntity extends EntityAbstract {
    ...
    constructor(props: StubEntityConstructorProps & EntityProps) {
        super(props);
...
class StubInMemorySearchableRepository extends InMemorySearchRepository<
    StubEntity,
    UniqueId
> {
...
describe("InMemorySearchableRepository Unit Tests", () => {
    ...
    describe("search method", () => {
        ...
        it("should search using filter with same entity", async () => {
            const item = new StubEntity({name: "test", price: 5});
